...
class FacebookHelperTestCase extends CakeTestCase {
	...
	public function testLocal() {
		@$View = new View ();
		$this->Facebook->__construct ( $View, array (
				'locale' => 'es_LA' 
		) );
	...
	public function testShare() {
		...
		$results = $this->Facebook->share ( 'not_here', array (
				'style' => 'link' 
		) );
	...
	public function testFanBox() {
		...
		$results = $this->Facebook->fanbox ( array (
				'stream' => true 
		) );
	...
	public function testPicture() {
		...
		$results = $this->Facebook->picture ( '12345', array (
				'size' => 'small' 
		) );
	...
	public function testLike() {
		...
		$results = $this->Facebook->like ( array (
				'layout' => 'button_count' 
		) );
	...
	public function testActivity() {
		...
		$results = $this->Facebook->activity ( array (
				'colorscheme' => 'dark' 
		) );
	...
	public function testFriendPile() {
		...
		$results = $this->Facebook->friendpile ( array (
				'colorscheme' => 'dark' 
		) );
	...
	public function testRecommendantions() {
		...
		$results = $this->Facebook->recommendations ( array (
				'colorscheme' => 'dark' 
		) );
	...
	public function testLivestream() {
		...
		$results = $this->Facebook->livestream ( array (
				'width' => '200',
				'height' => '300' 
		) );

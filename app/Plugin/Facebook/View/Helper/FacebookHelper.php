...
class FacebookHelper extends AppHelper {
	 ...
	 *
	 * @param
	 *        	string name to retrieve (default 'version')
	 *        	- 'name' => Plugin Name
	 *        	- 'author' => Author Name
	 *        	- 'email' => Support Email
	 *        	- 'link' => Support Link
	 ...
	 *
	 * @param
	 *        	string url: url to share with facebook (default current page)
	 * @param
	 *        	array options to pass into share
	 ...
	 * @param
	 *        	array options to pass into pic
	 ...
	 *
	 * @param
	 *        	string url: url to send with facebook (default current page)
	 * @param
	 *        	array options to pass into share
	 ...
	 * @param
	 *        	array of options to pass into likebox
	 ...
	 *
	 * @param
	 *        	array options to pass into fanbox
	 ...
	 *
	 * @param
	 *        	array options to pass into livestream
	 ...
	 *
	 * @param
	 *        	array of options for recommendations
	 ...
	 *        	string fb:tag
	 * @param
	 *        	string label to pass inbetween the tag
	 * @param
	 *        	array of options as name=>value pairs to add to facebook tag attribute
	 * @access private
	 */
